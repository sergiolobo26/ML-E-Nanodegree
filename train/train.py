...
def _get_train_data_loader(batch_size, training_dir, train_eval='Training'):
    print("Get train data loader.")
    
    filename = 'train.csv' if train_eval == 'Training' else 'validation.csv'
    train_data = pd.read_csv(os.path.join(training_dir, filename), header=None, names=None)
...
if __name__ == '__main__':
    ...
    eval_loader = _get_train_data_loader(args.batch_size, args.data_dir, train_eval = 'Validation')
